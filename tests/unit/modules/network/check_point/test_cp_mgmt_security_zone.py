...
from ansible_collections.checkpoint.checkpoint.plugins.modules import cp_mgmt_security_zone
...
function_path = 'ansible_collections.checkpoint.checkpoint.plugins.modules.cp_mgmt_security_zone.api_call'
