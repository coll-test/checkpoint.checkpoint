...
from ansible_collections.checkpoint.checkpoint.plugins.modules import cp_mgmt_threat_profile
...
function_path = 'ansible_collections.checkpoint.checkpoint.plugins.modules.cp_mgmt_threat_profile.api_call'
