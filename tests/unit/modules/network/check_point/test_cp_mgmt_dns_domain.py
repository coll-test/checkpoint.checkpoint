...
from ansible_collections.checkpoint.checkpoint.plugins.modules import cp_mgmt_dns_domain
...
function_path = 'ansible_collections.checkpoint.checkpoint.plugins.modules.cp_mgmt_dns_domain.api_call'
