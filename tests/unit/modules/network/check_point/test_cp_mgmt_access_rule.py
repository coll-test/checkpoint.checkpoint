...
from ansible_collections.checkpoint.checkpoint.plugins.modules import cp_mgmt_access_rule
...
function_path = 'ansible_collections.checkpoint.checkpoint.plugins.modules.cp_mgmt_access_rule.api_call'
