...
from ansible_collections.checkpoint.checkpoint.plugins.modules import cp_mgmt_group_with_exclusion
...
function_path = 'ansible_collections.checkpoint.checkpoint.plugins.modules.cp_mgmt_group_with_exclusion.api_call'
