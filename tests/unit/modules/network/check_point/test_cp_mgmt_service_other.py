...
from ansible_collections.checkpoint.checkpoint.plugins.modules import cp_mgmt_service_other
...
function_path = 'ansible_collections.checkpoint.checkpoint.plugins.modules.cp_mgmt_service_other.api_call'
