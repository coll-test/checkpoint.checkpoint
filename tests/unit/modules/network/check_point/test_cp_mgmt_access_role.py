...
from ansible_collections.checkpoint.checkpoint.plugins.modules import cp_mgmt_access_role
...
function_path = 'ansible_collections.checkpoint.checkpoint.plugins.modules.cp_mgmt_access_role.api_call'
