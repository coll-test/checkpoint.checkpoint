...
from ansible_collections.checkpoint.checkpoint.plugins.modules import cp_mgmt_application_site
...
function_path = 'ansible_collections.checkpoint.checkpoint.plugins.modules.cp_mgmt_application_site.api_call'
