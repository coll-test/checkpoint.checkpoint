...
from ansible_collections.checkpoint.checkpoint.plugins.modules import cp_mgmt_threat_rule
...
function_path = 'ansible_collections.checkpoint.checkpoint.plugins.modules.cp_mgmt_threat_rule.api_call'
