...
from ansible_collections.checkpoint.checkpoint.plugins.modules import cp_mgmt_simple_gateway
...
function_path = 'ansible_collections.checkpoint.checkpoint.plugins.modules.cp_mgmt_simple_gateway.api_call'
