...
from ansible_collections.checkpoint.checkpoint.plugins.modules import cp_mgmt_multicast_address_range
...
function_path = 'ansible_collections.checkpoint.checkpoint.plugins.modules.cp_mgmt_multicast_address_range.api_call'
