...
from ansible_collections.checkpoint.checkpoint.plugins.modules import cp_mgmt_service_icmp6
...
function_path = 'ansible_collections.checkpoint.checkpoint.plugins.modules.cp_mgmt_service_icmp6.api_call'
