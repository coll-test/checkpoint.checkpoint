...
from ansible_collections.checkpoint.checkpoint.plugins.modules import cp_mgmt_threat_layer
...
function_path = 'ansible_collections.checkpoint.checkpoint.plugins.modules.cp_mgmt_threat_layer.api_call'
