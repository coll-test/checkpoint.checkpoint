...
from ansible_collections.checkpoint.checkpoint.plugins.modules import cp_mgmt_wildcard
...
function_path = 'ansible_collections.checkpoint.checkpoint.plugins.modules.cp_mgmt_wildcard.api_call'
