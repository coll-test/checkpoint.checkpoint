...
from ansible_collections.checkpoint.checkpoint.plugins.modules import cp_mgmt_administrator
...
function_path = 'ansible_collections.checkpoint.checkpoint.plugins.modules.cp_mgmt_administrator.api_call'
