...
from ansible_collections.checkpoint.checkpoint.plugins.modules import cp_mgmt_application_site_group
...
function_path = 'ansible_collections.checkpoint.checkpoint.plugins.modules.cp_mgmt_application_site_group.api_call'
