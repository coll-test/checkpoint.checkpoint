...
from ansible_collections.checkpoint.checkpoint.plugins.modules import cp_mgmt_time
...
function_path = 'ansible_collections.checkpoint.checkpoint.plugins.modules.cp_mgmt_time.api_call'
