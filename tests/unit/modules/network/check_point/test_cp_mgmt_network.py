...
from ansible_collections.checkpoint.checkpoint.plugins.modules import cp_mgmt_network
...
function_path = 'ansible_collections.checkpoint.checkpoint.plugins.modules.cp_mgmt_network.api_call'
