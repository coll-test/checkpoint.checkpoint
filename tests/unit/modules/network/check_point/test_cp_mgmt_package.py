...
from ansible_collections.checkpoint.checkpoint.plugins.modules import cp_mgmt_package
...
function_path = 'ansible_collections.checkpoint.checkpoint.plugins.modules.cp_mgmt_package.api_call'
