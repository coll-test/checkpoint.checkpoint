...
from ansible_collections.checkpoint.checkpoint.plugins.modules import cp_mgmt_vpn_community_meshed
...
function_path = 'ansible_collections.checkpoint.checkpoint.plugins.modules.cp_mgmt_vpn_community_meshed.api_call'
