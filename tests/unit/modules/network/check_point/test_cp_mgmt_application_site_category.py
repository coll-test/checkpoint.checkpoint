...
import pytest
from ansible_collections.checkpoint.checkpoint.tests.unit.modules.utils import set_module_args, exit_json, fail_json, AnsibleExitJson

from ansible.module_utils import basic
from ansible_collections.checkpoint.checkpoint.plugins.modules import cp_mgmt_application_site_category
...
function_path = 'ansible_collections.checkpoint.checkpoint.plugins.modules.cp_mgmt_application_site_category.api_call'
...
class TestCheckpointApplicationSiteCategory(object):
    ...
    def connection_mock(self, mocker):
        connection_class_mock = mocker.patch('ansible_collections.checkpoint.checkpoint.plugins.module_utils.network.checkpoint.checkpoint.Connection')
