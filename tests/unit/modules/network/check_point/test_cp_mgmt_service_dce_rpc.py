...
from ansible_collections.checkpoint.checkpoint.plugins.modules import cp_mgmt_service_dce_rpc
...
function_path = 'ansible_collections.checkpoint.checkpoint.plugins.modules.cp_mgmt_service_dce_rpc.api_call'
