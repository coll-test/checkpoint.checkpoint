...
from ansible_collections.checkpoint.checkpoint.plugins.modules import cp_mgmt_global_assignment
...
function_path = 'ansible_collections.checkpoint.checkpoint.plugins.modules.cp_mgmt_global_assignment.api_call'
