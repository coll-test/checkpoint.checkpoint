...
from ansible_collections.checkpoint.checkpoint.plugins.modules import cp_mgmt_host
...
function_path = 'ansible_collections.checkpoint.checkpoint.plugins.modules.cp_mgmt_host.api_call'
